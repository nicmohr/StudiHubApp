sap.ui.define([
	...
	return Base.extend("Mosbach.StudiHub.controller.Carrer.DetailCareer", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf Mosbach.StudiHub.view.DetailCarrer
		 */
		extendInit: function () {
			this.oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			this.oRouter.getRoute("RouteDetailCareer").attachPatternMatched(this._onObjectMatched, this);
		...
		_onObjectMatched: function (oEvent) {
			...
			var sSet = "/CareerSet('" + this.postId.substr(1) + "')";
			var sLocation;
		...
		onEditCareerPress: function () {
			this.oRouter.navTo("RouteEditCareer", {
				ID: this.postId
			});
		},
