sap.ui.define([
	...
	return Base.extend("Mosbach.StudiHub.controller.Event.DetailEvent", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf Mosbach.StudiHub.view.DetailEvent
		 */
		extendInit: function () {
			this.oRouter.getRoute("RouteDetailEvent").attachPatternMatched(this._onObjectMatched, this);
		...
		_onObjectMatched: function (oEvent) {
			...
			var sSet = "/EventSet('" + this.postId.substr(1) + "')";
			var sLocation;
		...
		onEditEventPress: function () {
			this.oRouter.navTo("RouteEditEvent", {
				ID: this.postId
			});
		},
