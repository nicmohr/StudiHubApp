sap.ui.define([
	...
	return Base.extend("Mosbach.StudiHub.controller.Event.CreateEvent", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf Mosbach.StudiHub.view.CreateEvent
		 */
		extendInit: function () {
			this.onLiveChange();
			this.oRouter.getRoute("RouteCreateEvent").attachPatternMatched(this._onObjectMatched, this);
		},
		...
		saveEvent: function (oEvent) {
			var that = this;
			var sId;
			this.oModel.create("/EventSet", oEvent, {
				...
				error: function () {
					MessageToast.show("Fehler beim Speichern des Event!");
				}
			});
		},
