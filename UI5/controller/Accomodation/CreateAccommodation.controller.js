sap.ui.define([
	...
	return Base.extend("Mosbach.StudiHub.controller.Accomodation.CreateAccommodation", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf Mosbach.StudiHub.view.CreateAccommodation
		 */
		extendInit: function () {
			this.onLiveChange();
			this.oRouter.getRoute("RouteCreateAccommodation").attachPatternMatched(this._onObjectMatched, this);
		},
		...
		_onObjectMatched: function () {
			...
			this.byId("inputRooms").setValue("1");
		...
		saveAccom: function (oAccom) {
			var that = this;
			var sId;
			this.oModel.create("/AccomSet", oAccom, {
