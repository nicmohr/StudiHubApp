sap.ui.define([
	...
	return Base.extend("Mosbach.StudiHub.controller.Job.DetailJob", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf Mosbach.StudiHub.view.DetailJob
		 */
		extendInit: function () {
			this.oRouter.getRoute("RouteDetailJob").attachPatternMatched(this._onObjectMatched, this);
		...
		_onObjectMatched: function (oEvent) {
			...
			var sSet = "/JobSet('" + this.postId.substr(1) + "')";
			var sLocation;
		...
		onEditJobPress: function () {
			this.oRouter.navTo("RouteEditJob", {
				ID: this.postId
			});
		},
